(function () {
  ...
  function render(ctx, state) {
    ...
    var optX = panelX + pad;
    drawCheckbox(ctx, optX,       cursor, 'Special tiles (+12 crystal, ? wildcard, +10 ember)', state.settings.specialTiles, function() { state.settings.specialTiles = !state.settings.specialTiles; });
    cursor += 24;
