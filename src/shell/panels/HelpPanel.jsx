...
const Kbd = ({ children }) => (
  <span style={{ padding: '1px 6px', border: '1px solid var(--ink-soft)', fontSize: 11, color: 'var(--ink)', textAlign: 'center', minWidth: 28, display: 'inline-block', fontFamily: 'var(--font-mono)' }}>
    {children}
  </span>
);
      ...
      <div style={{ flex: 1, display: 'grid', gridTemplateColumns: '1.1fr 1fr', gap: 28, minHeight: 0 }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 18, paddingLeft: 24, borderLeft: '1px solid var(--rule-faint)' }}>
          ...
          <Step n="v." title="A run is three pages">
            ...
            <p style={{ margin: '10px 0 0', fontSize: 12, fontStyle: 'italic', color: 'var(--ink-soft)', lineHeight: 1.5 }}>
